...
def write_results(
    ...
    md_parts = [
        ...
        "",
        official_metrics["description"],
        "",
        metrics_table(official_metrics),
        "",
        "### Confusion matrix",
        "",
        "Rows = actual, columns = predicted.",
        "",
        confusion_section(official_metrics),
        "",
        "### Classification report",
        "",
        "```",
        official_metrics["classification_report"].rstrip(),
        "```",
    ]
    ...
    payload = {
        ...
        "official_test_file": test_path.name,
        "evaluation": {
            k: official_metrics[k]
            for k in [
                "split",
                "accuracy",
                "precision",
...
def main() -> None:
    ...
    print_metrics("Official NSL-KDD test:", official_metrics)
